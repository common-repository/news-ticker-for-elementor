...
function wbelnt_menu_page(){
	...
	$submenu["wbel-news-ticker"][4] = array( $link_text, 'manage_options' , 'https://plugin-devs.com/product/news-ticker-for-elementor/' );
...
?>
	    <div class="wrap">
	        ...
	        <form id="custom_js_form" method="post" action="#" onsubmit="return false;" style="margin-top: 15px;">
	            ...
	            <p><input type="submit" class="button-primary disabled" value="<?php _e( 'Save Changes' ) ?>" /><a href="https://plugin-devs.com/product/news-ticker-for-elementor/" target="_blank" class="button" style="background: #FCB214; color: #fff;font-weight: 700; margin-left: 10px">Upgrade to Pro</a></p>
	        </form>
	    </div>
<?php
}
